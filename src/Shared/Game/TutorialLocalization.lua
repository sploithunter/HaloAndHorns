...
local CATALOG = {
    ...
    es = {
        ...
        ["tutorial.hatch_first_egg.body"] = "Tu compañero necesita otro aliado. Sigue el camino al Huevo Wayfinder y abre uno.",
        ["tutorial.hatch_first_egg.body_gamepad"] = "Tu compañero necesita otro aliado. Sigue el camino al Huevo Wayfinder y pulsa X para abrirlo.",
        ...
        ["tutorial.first_fight.body"] = "¡Algo entró en el granero! Ve allí; tus mascotas lucharán por ti. Expúlsalo y recoge sus Waycoins.",
    ...
    ["pt-br"] = {
        ...
        ["tutorial.hatch_first_egg.body"] = "Seu companheiro precisa de um aliado. Siga o caminho até o Ovo Wayfinder e abra um.",
        ["tutorial.hatch_first_egg.body_gamepad"] = "Seu companheiro precisa de um aliado. Siga o caminho até o Ovo Wayfinder e aperte X para abrir um.",
        ...
        ["tutorial.first_fight.body"] = "Algo entrou no celeiro! Vá até lá; seus pets lutarão por você. Expulse-o e recolha as Waycoins.",
