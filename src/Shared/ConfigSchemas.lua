...
local SCHEMAS = {
    ...
    merge_stress_host = schema({
        sample_seconds = "number",
        maximum_seconds = "number",
        maximum_footprint_gib = "number",
        maximum_growth_gib = "number",
        maximum_start_footprint_gib = "number",
        maximum_pressure_level = "number",
