...
the shop can say **Founder Benefit** honestly. The creator no-pass balance gate suppresses the entire
effective union while off; it does not delete the underlying selection.
