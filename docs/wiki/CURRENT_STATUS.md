...
- Twenty-four server notification packets now come from the validated network manifest. Progression, economy, interaction, combat-presentation, and player-status slices preserve existing wire names and payload tuples; 74 legacy constructors remain under the architecture ratchet.
