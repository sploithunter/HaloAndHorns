...
- The Kade developer pet follows the regular Colorado reward contract and uses packaged Roblox model assets: normal/rainbow use `107161152905013`, golden uses `139643909402590`. Admin tools can grant all four visual test forms. Kade has no egg or acquisition source yet; those remain pending the authored egg.
