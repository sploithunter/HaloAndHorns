...
- The Kade developer pet follows the regular Colorado reward contract and uses packaged Roblox model assets: normal/rainbow use `107161152905013`, golden uses `139643909402590`. Admin tools can grant all four visual test forms. Meeting Kade (`536245038`) now grants the once-ever, inventory-only `kade_egg`; it mirrors Colorado's fixed odds (5% Golden, 0.5% Rainbow, 1% Huge) and uses group-owned icon `75293308801530` plus runtime-assembled mesh/texture `103492246635387` / `137761201042755`.
