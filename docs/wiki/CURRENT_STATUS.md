...
- Twenty server notification packets now come from the validated network manifest. Progression, economy, interaction, and combat-presentation slices preserve existing wire names and payload tuples; 78 legacy constructors remain under the architecture ratchet.
