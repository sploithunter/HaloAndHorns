...
- [Merge an Egg Prototype](MERGE_EGG_PROTOTYPE.md) — Studio-only Phase 6: one authored land strip,
  four empty hatcher positions, world-owned 3/4/5/6 capacity, composition-aware tier-N egg drafts,
  an actual-walk-speed Home→Heaven 1 economy runner with isolated Heaven starts, 20-wave stage
  ladders, a five-egg defeat objective, and stable-slot reinforcement FIFOs.
