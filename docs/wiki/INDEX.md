...
- [Merge an Egg Prototype](MERGE_EGG_PROTOTYPE.md) — Studio-only Phase 1: one authored land strip,
  the disabled Home Hall gate, five temporary Wayfinder units, and one reward-free test wave.
