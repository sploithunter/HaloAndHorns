...
- [Merge an Egg Prototype](MERGE_EGG_PROTOTYPE.md) — Studio-only Phase 2: one authored land strip,
  one stationary hatcher NPC with five observable Wayfinders, and escalating march waves.
