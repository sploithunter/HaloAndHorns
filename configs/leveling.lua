...
return {
    ...
    -- September onboarding retune: combat/mining get 5x their former award at levels 1–3,
    -- 4x at level 4, and a smaller bridge at level 5. Level 6+ and quest lumps are unchanged.
    -- At level 3 before difficulty/buffs: S/M/L ore = 13/63/250, even-level trash = 75 XP.
    onramp = {
        below_level = 5,
        xp_mult = 1.5,
        xp_mult_by_source = {
        ...
        activity_mult_by_level = {
            mining = { 12.5, 12.5, 12.5, 10, 5 },
            combat = { 12.5, 12.5, 12.5, 10, 5 },
        },
        crystal_mult = 1.5,
    },
    ...
    combat_xp = {
        xp_per_level = 2.0,
        -- lieutenant / boss / ARCH-VILLAIN premium (archvillain = the super-boss tier above boss)
        rank_xp_mult = { trash_mob = 1.0, mid_tier = 1.6, boss = 3.0, archvillain = 6.0 },
    },
    ...
    combat_coins = {
        coins_per_level = 1.0,
        rank_coin_mult = { trash_mob = 1.0, mid_tier = 1.6, boss = 3.0, archvillain = 6.0 },
    },
    ...
    rank_offset = {
        ...
        boss = 2, -- boss
        archvillain = 3, -- arch-villain (the capital baddie reads three levels up)
    },
