...
return {
    ...
    disarm = "Disarms a target: it can move, but cannot attack or use powers.",
    focus_fire = {
        type = "Single Target Accuracy Mark",
        desc = "Mark an enemy: your squad and hostile powers hit it more accurately, and holds may pierce innate immunity.",
    },
    deep_freeze = "Fully freezes one enemy: no movement, attacks, or powers.",
    frost_field = "Freezes enemies within 20 studs of you in place.",
    permafrost = "Signature: roots the focused enemy's nearby encounter group.",
    shatter = "Shatters enemies within 20 studs of the target: they take ×2.2 damage, or ×3.08 while frozen.",
