return {
    zones = {
        ...
        -- zones (Lava/Ice/Desert/Grass), unlock-gated at 50k of the origin's coin, any order
        -- (was 100k — Jason 2026-07-09: prohibitive even on double-drop Frenzy Friday; the
        -- FIRST realm zone is paid from homeworld rates, so 100k = ~3x the Desert chapter)
        ...
        -- Heaven_1: four independent per-origin zones (unlock any order, 50k each).
        Heaven_1_Lava = {
            id = "Heaven_1_Lava",
            kind = "area",
            element = "lava",
        ...
        -- Hell_1: four independent per-origin zones (unlock any order, 50k each).
        Hell_1_Lava = {
            id = "Hell_1_Lava",
            kind = "area",
            element = "lava",
