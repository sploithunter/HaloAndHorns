...
return {
    ...
    packets = {
        ...
        Squad_Recall = {
            ...
            delivery = "request",
            rate_limit = 30,
            handler = "EnemyService.RecallPet",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        Squad_Summon = {
            ...
            delivery = "request",
            rate_limit = 30,
            handler = "EnemyService.SummonPet",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        Power_ToggleActive = {
            ...
            delivery = "request",
            rate_limit = 30,
            handler = "PowerService.ToggleActive",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        Combat_SetAssist = {
            ...
            delivery = "request",
            rate_limit = 60,
            handler = "EnemyService.SetAssistTarget",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        },
        Combat_SelectPetTarget = {
            name = "Combat_SelectPetTarget",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 60,
            handler = "EnemyService.SelectPetTarget",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        Hotbar_Activate = {
            ...
            delivery = "request",
            rate_limit = 180,
            handler = "HotbarService.Activate",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        Hotbar_RequestState = {
            ...
            delivery = "request",
            rate_limit = 90,
            handler = "HotbarService.GetState",
            schema = { kind = "tuple", arguments = {} },
        },
        CurrencyUpdate = {
            name = "CurrencyUpdate",
