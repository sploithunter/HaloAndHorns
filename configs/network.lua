...
return {
    ...
    packets = {
        ...
        Settings_SetMergeDefenseMode = {
            name = "Settings_SetMergeDefenseMode",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "SettingsService.SetMergeDefenseMode",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        WorldTravel_Open = {
            name = "WorldTravel_Open",
            transport = "reliable_event",
            direction = "server_to_client",
            authorization = "server",
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "world_travel.open",
            schema = {
                kind = "tuple",
                arguments = { { name = "catalog", type = "table" } },
            },
        },
        WorldTravel_Select = {
            name = "WorldTravel_Select",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 10,
            handler = "WorldTravelService.Select",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        WorldTravel_Result = {
            name = "WorldTravel_Result",
            transport = "reliable_event",
            direction = "server_to_client",
            authorization = "server",
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "world_travel.result",
            schema = {
                kind = "tuple",
                arguments = { { name = "result", type = "table" } },
            },
        ...
        Admin_GetPlayerSnapshot = {
            name = "Admin_GetPlayerSnapshot",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 10,
            handler = "AdminToolsService.GetPlayerSnapshot",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_ForceSave = {
            name = "Admin_ForceSave",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 5,
            handler = "AdminToolsService.ForceSave",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_GrantPet = {
            name = "Admin_GrantPet",
            ...
            delivery = "request",
            rate_limit = 20,
            handler = "AdminToolsService.GrantPet",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_RetirePet = {
            name = "Admin_RetirePet",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "AdminToolsService.RetirePet",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_ResetPets = {
            name = "Admin_ResetPets",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 5,
            handler = "AdminToolsService.ResetPets",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_ResetToBeginning = {
            name = "Admin_ResetToBeginning",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 5,
            handler = "AdminToolsService.ResetToBeginning",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_SetZoneLock = {
            name = "Admin_SetZoneLock",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "AdminToolsService.SetZoneLock",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_SetHatchEntitlement = {
            name = "Admin_SetHatchEntitlement",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
        ...
        Admin_SpawnEnemy = {
            ...
            delivery = "request",
            rate_limit = 30,
            handler = "AdminToolsService.SpawnEnemy",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Squad_AdminKill = {
            name = "Squad_AdminKill",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "EnemyService.AdminKillPet",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_SetArea = {
            name = "Admin_SetArea",
            ...
            delivery = "request",
            rate_limit = 20,
            handler = "ZoneService.SetArea",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_GrantAreaPowers = {
            name = "Admin_GrantAreaPowers",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 5,
            handler = "HotbarService.GrantAreaPowers",
            schema = { kind = "tuple", arguments = {} },
        },
        Admin_CastPower = {
            name = "Admin_CastPower",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 120,
            handler = "PowerService.AdminCast",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_TogglePassive = {
            name = "Admin_TogglePassive",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 60,
            handler = "PowerService.AdminTogglePassive",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_RequestHatchHistory = {
            name = "Admin_RequestHatchHistory",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 10,
            handler = "AdminToolsService.GetHatchHistory",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_RequestHatchSimulation = {
            name = "Admin_RequestHatchSimulation",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "AdminToolsService.SimulateHatch",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        Admin_EventCommand = {
            name = "Admin_EventCommand",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "admin",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 20,
            handler = "AdminToolsService.EventCommand",
            schema = { kind = "tuple", arguments = { { name = "request", type = "table" } } },
        },
        ShopItemsRequest = {
            name = "ShopItemsRequest",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
        ...
        TutorialStateRequest = {
            ...
            delivery = "request",
            rate_limit = 10,
            handler = "TutorialService.GetState",
            schema = { kind = "tuple", arguments = {} },
        },
        TutorialState = {
            name = "TutorialState",
        ...
        StarterPetStateRequest = {
            ...
            delivery = "request",
            rate_limit = 10,
            handler = "StarterPetService.GetState",
            schema = { kind = "tuple", arguments = {} },
        },
        StarterPetChoose = {
            name = "StarterPetChoose",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 5,
            handler = "StarterPetService.Choose",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        StarterPetState = {
            name = "StarterPetState",
            transport = "reliable_event",
            direction = "server_to_client",
            authorization = "server",
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "starter_pet.state",
            schema = {
                kind = "tuple",
                arguments = { { name = "state", type = "table" } },
            },
        },
        ActiveEffectsRequest = {
            name = "ActiveEffectsRequest",
            transport = "reliable_event",
            direction = "client_to_server",
            authorization = "player",
            environments = { production = true, studio = true, test = true },
            delivery = "request",
            rate_limit = 30,
            handler = "EventService.GetActiveEffects",
            schema = { kind = "tuple", arguments = {} },
        },
        ActiveEffects = {
            name = "ActiveEffects",
        ...
        RunDiagnosticsRequest = {
            ...
            delivery = "request",
            rate_limit = 5,
            handler = "DiagnosticsService.Run",
            schema = { kind = "tuple", arguments = {} },
        },
        RunDiagnostics = {
            name = "RunDiagnostics",
        ...
        AutomationControl = {
            ...
            delivery = "player",
            topic = "automation.controls",
            schema = {
                kind = "tuple",
                arguments = { { name = "enabled", type = "boolean" } },
            },
        },
        RunAutomationSuite = {
            name = "RunAutomationSuite",
            transport = "remote_function",
            location = "replicated_storage",
            direction = "client_to_server",
        ...
        MergeEggPrototypeBoardAction = {
            ...
            delivery = "request",
            rate_limit = 30,
            handler = "MergeEggPrototypeService.HandleBoardAction",
            schema = {
                kind = "tuple",
                arguments = { { name = "request", type = "table" } },
            },
        ...
        MergeEggPrototypeBoardResult = {
            name = "MergeEggPrototypeBoardResult",
            transport = "reliable_event",
            location = "replicated_storage",
            direction = "server_to_client",
            authorization = "server",
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "merge_egg_prototype.board_result",
            schema = {
                kind = "tuple",
                arguments = { { name = "result", type = "table" } },
            },
        ...
        MergeEggPrototypePlayerHatch = {
            ...
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "merge_egg_prototype.player_hatch",
            schema = {
                kind = "tuple",
                arguments = { { name = "result", type = "table" } },
            },
        },
        MergeEggPrototypeModeNotice = {
            name = "MergeEggPrototypeModeNotice",
            transport = "reliable_event",
            location = "replicated_storage",
            direction = "server_to_client",
            authorization = "server",
            environments = { production = true, studio = true, test = true },
            delivery = "player",
            topic = "merge_egg_prototype.mode_notice",
            schema = {
                kind = "tuple",
                arguments = { { name = "notice", type = "table" } },
            },
        },
        MergeEggPrototypeModeNoticeResponse = {
            name = "MergeEggPrototypeModeNoticeResponse",
            transport = "reliable_event",
            location = "replicated_storage",
            direction = "client_to_server",
            authorization = "player",
            ...
            delivery = "request",
            rate_limit = 4,
            handler = "SettingsService.ResolveMergeDefenseModeNotice",
            schema = {
                kind = "tuple",
                arguments = { { name = "response", type = "table" } },
            },
        ...
        EggOpened = {
            ...
            delivery = "request",
            rate_limit = 120,
            handler = "EggService.HandleEggPurchase",
            schema = {
                kind = "tuple",
                arguments = {
        ...
        setLastEgg = {
            ...
            delivery = "request",
            rate_limit = 60,
            handler = "EggService.SetLastEgg",
            schema = {
                kind = "tuple",
                arguments = { { name = "eggType", type = "string" } },
            },
        },
        GameAPICommand = {
            name = "GameAPICommand",
            ...
            delivery = "request",
            rate_limit = 240,
            handler = "GameAPIService.ExecuteNetwork",
            schema = {
                kind = "tuple",
                arguments = {
        ...
        StudioSmokeTest = {
            ...
            delivery = "request",
            rate_limit = 120,
            handler = "StudioSmokeTestService.Run",
            schema = {
                kind = "tuple",
                arguments = {
