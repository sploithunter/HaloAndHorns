...
return {
    ...
    -- Consumables
    {
        ...
        use_feedback = { target_scope = "pets" },
        effects = {
    ...
    -- the timer while the purchase dialog is still open.
    {
        ...
        rarity = "special",
        description = "Summon Your Future Self and their four-pet squad.",
        locked_description = "Reach Level 4 to summon Your Future Self.",
        unlock_level = 4,
        icon_power = "world_travel",
        use_feedback = { target_scope = "player", destination_attr = "FutureCall" },
    ...
    },
    {
        ...
        icon_power = "xp_surge",
        use_feedback = { target_scope = "player", destination_attr = "XpProductBuff" },
    ...
    },
    {
        ...
        use_feedback = { target_scope = "player", destination_attr = "CoinProductBuff" },
