...
return {
    ...
    arch_lightning = {
        ...
        -- Owned by the dedicated Hell-gate endpoint controller, even if Hall is enabled later.
        excluded_host_prefixes = { "HellGateCrisp_" },
        hide_markers = true,
        sample_rows = 9,
        cluster_radius = 48,
        view_distance = 180,
    ...
    -- Merge's authored Hell gates are independent of the disabled Hall route.
    -- Marker positions remain Studio-owned; no runtime stamping or repositioning.
    hell_gate_lightning = {
        enabled = true,
        ...
        markers = {
            ...
            crown = { "lightning3TopPoint" },
            left = {
                "lightningSidePointLeft",
                "lightningInnerSideLeft1",
                "lightningInnerSideLeft2",
                "lightningInnerSideLeft3",
                "lightningInnerSideLeft4",
                "lightningInnerSideLeft5",
            },
            right = {
                "lightningSidePointRight",
                "lightningInnerSideRight1",
                "lightningInnerSideRight2",
                "lightningInnerSideRight3",
                "lightningInnerSideRight4",
                "lightningInnerSideRight5",
            },
        },
        hide_markers = true,
        respect_prop_effects = true,
        rescan_seconds = 2,
        update_seconds = 0.1,
        view_distance = 520,
        maximum_visible_gates = 2,
        maximum_active_strikes = 2,
        lifetime_margin_seconds = 0.1,
        minimum_span = 1,
        sky_interval = { 4, 7 },
        inner_interval = { 0.7, 1.4 },
        bolt = {
            enabled = true,
            duration = 0.4,
            thickness = 0.28,
            ...
            target_offset = { 0, 0, 0 },
            colors = { { 255, 90, 65 }, { 190, 110, 255 }, { 245, 210, 255 } },
            sound_name = "_silent",
        },
    },
